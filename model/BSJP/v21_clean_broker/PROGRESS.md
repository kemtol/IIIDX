...
- [ ] **Step 4.** Run `train_lightgbm.py --output-dir model/BSJP/bsjp_v21_clean_broker --feature-modules-dir … --tp-pct 0.01 --sl-pct -0.02 --oot-valid-days 100` — same hyperparam as v19d.
